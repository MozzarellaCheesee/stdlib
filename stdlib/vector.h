...
namespace mystd {
    ...
    public:
        // ─── Конструкторы ───────────────────────────────────────────
        Vector() noexcept = default;                                // Конструктор по умолчанию
        ...
        Vector(const Vector&) noexcept;                             // Конструктор копирования
    ...
    private:
        ...
        std::unique_ptr<T[]> data_     = nullptr;                   // Указатель на массив данных
